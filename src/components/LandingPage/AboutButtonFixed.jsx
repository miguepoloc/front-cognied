...
export const AboutButtonFixed = ({ section }) => {
    return (
        <section  className="mt-lg-5 mt-md-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path className='fill_aboutButtonFixed' d="M0,160L48,170.7C96,181,192,203,288,197.3C384,192,480,160,576,133.3C672,107,768,85,864,80C960,75,1056,85,1152,96C1248,107,1344,117,1392,122.7L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
            <div className="bg_aboutButtonFixed" id={section.id}>
                <div className="container pb-5">
                    <div className="row" >
                        <h3  className="font-Geomanist display-6 fw-bold text-center text-white mb-5 ">¿Y has visto este boton que te sigue durante la página?</h3>
                    </div>
                    <div className="row">
                        ...
                        <div className=" col-lg-7 col-md-12 mt-md-0 mt-3 col-12 justify-content-center align-self-center text-white">

                            <h5 className='text-center'>Somos una estrategia digital de promoción de la salud mental dirigida
                            ...
                            <h5 className='text-center mt-5'>A través del chat virtual disponible en esa página,
