...
const Objetives = ({ section }) => {
    return (
        ...
        >
            ...
            <h2 className="font-Geomanist display-5 fw-bold text-center text-white py-5 ">Módulos</h2>
                <div className="row mb-4 align-items-md-stretch ms-4">
                    <div className="col-lg-4 col-md-6">
                        <div className="row h-100 p-5 text-white item1 rounded-3 flex-center ">
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="row h-100 mx-2 p-5 text-white item1 rounded-3 flex-center ">
                            <div className="col-lg-8 order-2 order-lg-1 ">
                                <h2 className="font-Geomanist">
                                    Mis emociones
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="row h-100 p-5 text-white item1 me-4 rounded-3 flex-center ">
                            <div className="col-lg-8 order-2 order-lg-1 ">
                                <h2 className="font-Geomanist">
                                    Piénsalo
                    ...
                    <div className="col-lg-6 ">
                        <div className="row h-100 p-5 text-white item1 mt-4 rounded-3 flex-center ">
                            <div className="col-lg-8 order-2 order-lg-1 ">
                                <h2 className="font-Geomanist">
                                    Mis habilidades
                    ...
                    <div className="col-lg-6 ">
                        <div className="row h-100 p-5 text-white item1 mt-4 mx-4 rounded-3 flex-center ">
                            <div className="col-lg-8 order-2 order-lg-1 ">
                                <h2 className="font-Geomanist">
