...
export const Unete = ({ section }) => {
    return (
        <>
            <section id={section.id} className="backgroundColor_Team " >
                <div className="Team pb-5">
                    ...
                    <div className="container pb-md-5 mt-5">
                        ...
                        <div className="row" >
                            <h3 className="font-Geomanist display-6 fw-bold text-center titulo_aboutUs mb-5 ">ESTUDIANTE, UNÉTE A DIGITALMENTE, DONDE TÚ ERES EL PROTAGONISTA!</h3>
                        </div>
