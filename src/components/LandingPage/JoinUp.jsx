                ...
                <div className="Team pb-5">
                    ...
                    <div className="container pb-md-5 mt-5">
                        ...
                        <div className="row" >
                            ...
                            <a href="https://www.instagram.com/proyecto.dimente.unimag/" target="_blank"><img src={logoInstagram} style={{width:"56px"}}/></a> <a href="https://www.facebook.com/DigitalMenteUnimagdalena/" target="_blank"><img src={logoFacebook} style={{width:"50px"}}/></a>       
                            </div>      
                        </div>
