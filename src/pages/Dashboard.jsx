...
import Rocket from '../assets2/img/illustrations/rocket-white.png'
import Rocket2 from '../assets2/img/shapes/waves-white.svg'
import Logoct from '../assets2/img/logo-ct.png'

// import '../assets2/css/nucleo-icons.css'
// import '../assets2/css/nucleo-svg.css'
// import '../assets2/css/soft-ui-dashboard.css'
      ...
      <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
                      ...
                      <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF" fillRule="nonzero">
                        <g transform="translate(1716.000000, 291.000000)">
                          <g transform="translate(304.000000, 151.000000)">
                            <polygon className="color-background opacity-6"
        ...
        <div className="sidenav-footer mx-3 ">
          <div className="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            <div className="full-background" style={{ backgroundImage: 'url("https://media.geeksforgeeks.org/wp-content/uploads/rk.png")' }}>
            </div>
            <div className="card-body text-start p-3 w-100">
              ...
              <div className="docs-info">
                ...
                <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard" target="_blank"
                  className="btn btn-white btn-sm w-100 mb-0" rel="noreferrer">Documentation</a>
              </div>
            </div>
          </div>
            ...
            <div className="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
              ...
              <ul className="navbar-nav  justify-content-end">
                <li className="nav-item d-flex align-items-center">
                  <a className="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank" href="https://www.creative-tim.com/builder/soft-ui?ref=navbar-dashboard" rel="noreferrer">Online Builder</a>
                </li>
                <li className="nav-item d-flex align-items-center">
          ...
          <div className="row mt-4">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                      <div className="bg-gradient-primary border-radius-lg h-100">
                        ...
                        <img src={Rocket2} className="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves" />
            ...
            <div className="col-lg-5">
              <div className="card h-100 p-3">
                <div className="overflow-hidden position-relative border-radius-lg bg-cover h-100" style={{ backgroundImage: 'url("https://media.geeksforgeeks.org/wp-content/uploads/rk.png")' }}>
                    ...
                    <div className="row">
                      <div className="col-3 py-3 ps-0">
                        <div className="d-flex mb-2">
                          <div
                            className="icon icon-shape icon-xxs shadow border-radius-sm bg-gradient-primary text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <div className="progress w-75">
                          <div className="progress-bar bg-dark w-60" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                      ...
                      <div className="col-3 py-3 ps-0">
                        <div className="d-flex mb-2">
                          <div
                            className="icon icon-shape icon-xxs shadow border-radius-sm bg-gradient-info text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <div className="progress w-75">
                          <div className="progress-bar bg-dark w-90" role="progressbar" aria-valuenow="90" aria-valuemin="0"
                            aria-valuemax="100"></div>
                        </div>
                      </div>
                      <div className="col-3 py-3 ps-0">
                        <div className="d-flex mb-2">
                          <div
                            className="icon icon-shape icon-xxs shadow border-radius-sm bg-gradient-warning text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <div className="progress w-75">
                          <div className="progress-bar bg-dark w-30" role="progressbar" aria-valuenow="30" aria-valuemin="0"
                            aria-valuemax="100"></div>
                        </div>
                      </div>
                      <div className="col-3 py-3 ps-0">
                        <div className="d-flex mb-2">
                          <div
                            className="icon icon-shape icon-xxs shadow border-radius-sm bg-gradient-danger text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="10px" height="10px" viewBox="0 0 40 40" version="1.1"
                              xmlns="http://www.w3.org/2000/svg">
                              <title>settings</title>
                              <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        ...
                        <div className="progress w-75">
                          <div className="progress-bar bg-dark w-50" role="progressbar" aria-valuenow="50" aria-valuemin="0"
                            aria-valuemax="100"></div>
                        </div>
                      </div>
                    </div>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              <div>
                                <img src="" className="avatar avatar-sm me-3" alt="xd" />
                              </div>
                        ...
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              <div>
                                <img src="../assets2/img/small-logos/logo-atlassian.svg" className="avatar avatar-sm me-3"
                                  alt="atlassian" />
                              </div>
                              <div className="d-flex flex-column justify-content-center">
                        ...
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              <div>
                                <img src="../assets2/img/small-logos/logo-slack.svg" className="avatar avatar-sm me-3"
                                  alt="team7" />
                              </div>
                              <div className="d-flex flex-column justify-content-center">
                        ...
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              <div>
                                <img src="../assets2/img/small-logos/logo-spotify.svg" className="avatar avatar-sm me-3"
                                  alt="spotify" />
                              </div>
                              <div className="d-flex flex-column justify-content-center">
                        ...
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              <div>
                                <img src="../assets2/img/small-logos/logo-jira.svg" className="avatar avatar-sm me-3" alt="jira" />
                              </div>
                              <div className="d-flex flex-column justify-content-center">
                        ...
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              <div>
                                <img src="../assets2/img/small-logos/logo-invision.svg" className="avatar avatar-sm me-3"
                                  alt="invision" />
                              </div>
                              <div className="d-flex flex-column justify-content-center">
